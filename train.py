from code import make_transformer
...
def get_model(config, vocab_src_len, vocab_tgt_len):
    model = make_transformer(config['seq_len'], config['seq_len'], vocab_src_len, vocab_tgt_len,d_model=config['d_model'])
    return model
...
def train_model(config):
    ...
    for epoch in range(initial_epoch, config['num_epochs']):
        ...
        for batch in batch_iterator:
            ...
            proj_output = model.linear_layer(decoder_output) # (B, seq_len, vocab_size)
